"""Stack-aware `doctor` for awvision.
...
interesting failures live BETWEEN them. "awvision is installed" is not the useful
fact -- "awvision is installed and the thing it pairs with is not" is. This reports
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWVISION_MODEL', 'AWVISION_URL']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awvision needs at runtime, and a
